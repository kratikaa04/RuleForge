...
🔗 Live demo: https://rule-forge-three.vercel.app/ 🔗 API: https://ruleforge-5ber.onrender.com

Note: the API is hosted on a free tier and may take 30-50 seconds to wake up if it's been idle.
...
## Stack
Backend: Haskell, Scotty, Aeson, Docker
Frontend: React, Vite
